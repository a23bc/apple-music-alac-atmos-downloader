...
📖 [中文教程 - 详见方法三](https://telegra.ph/Apple-Music-Alac 高解析度无损音乐下载教程 -04-02-2)
...
8. 找到包含以下格式的 URL：`.../syllable-lyrics?l=<语言代码>&extend=ttmlLocalizations`
9. 复制语言值并粘贴到 `config.yaml` 中
10. **可选：** 如需禁用发音，在 config.yaml 中移除对应值：`...%5D=<移除此值>&extend...`
11. 保存并照常运行脚本
